...
public class Noticias_Adapter extends ArrayAdapter<Object> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		placeHolder.time.setText(" " + noticias.get(position).getFecha().getDay()+"/"+noticias.get(position).getFecha().getMonth());
		placeHolder.content.setText("leer más");
        ...
        //ic_launcher deberia ser un icono por default, coloca el logo de ecotoolbox.
